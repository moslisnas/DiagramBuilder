            ...
            <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ duration: 1 }}>
                <motion.div animate={navigate ? { scale: 0, rotate: 180} : { scale: 1 }} transition={{ duration: 1 }}>
                    <Wheel width="343" height="343" viewBox="0 0 343 343" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <a href="/ods/1" title="ODS 1" onClick={(event) => animateAndNavigate(event, "/ods/1")}>
                        ...
                        <a href="/ods/2" title="ODS 2" onClick={(event) => animateAndNavigate(event, "/ods/2")}>
                        ...
                        <a href="/ods/3" title="ODS 3" onClick={(event) => animateAndNavigate(event, "/ods/3")}>
                        ...
                        <a href="/ods/4" title="ODS 4" onClick={(event) => animateAndNavigate(event, "/ods/4")}>
                        ...
                        <a href="/ods/5" title="ODS 5" onClick={(event) => animateAndNavigate(event, "/ods/5")}>
                        ...
                        <a href="/ods/6" title="ODS 6" onClick={(event) => animateAndNavigate(event, "/ods/6")}>
                        ...
                        <a href="/ods/7" title="ODS 7" onClick={(event) => animateAndNavigate(event, "/ods/7")}>
                        ...
                        <a href="/ods/8" title="ODS 8" onClick={(event) => animateAndNavigate(event, "/ods/8")}>
                        ...
                        <a href="/ods/9" title="ODS 9" onClick={(event) => animateAndNavigate(event, "/ods/9")}>
                        ...
                        <a href="/ods/10" title="ODS 10" onClick={(event) => animateAndNavigate(event, "/ods/10")}>
                        ...
                        <a href="/ods/11" title="ODS 11" onClick={(event) => animateAndNavigate(event, "/ods/11")}>
                        ...
                        <a href="/ods/12" title="ODS 12" onClick={(event) => animateAndNavigate(event, "/ods/12")}>
                        ...
                        <a href="/ods/13" title="ODS 13" onClick={(event) => animateAndNavigate(event, "/ods/13")}>
                        ...
                        <a href="/ods/14" title="ODS 14" onClick={(event) => animateAndNavigate(event, "/ods/14")}>
                        ...
                        <a href="/ods/15" title="ODS 15" onClick={(event) => animateAndNavigate(event, "/ods/15")}>
                        ...
                        <a href="/ods/16" title="ODS 16" onClick={(event) => animateAndNavigate(event, "/ods/16")}>
                        ...
                        <a href="/ods/17" title="ODS 17" onClick={(event) => animateAndNavigate(event, "/ods/17")}>
